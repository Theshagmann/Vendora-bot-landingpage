...
const Hero = () => {
  return (
    ...
    >
      <div className="absolute inset-0 sm:inset-2 sm:rounded-2xl bg-gradient-to-b from-[var(--primary)]/20 to-[var(--secondary)]/60 to-[var(--white)]/10"></div>
      <div className="relative ml-8 mt-35 z-10">
        ...
        >
          With features like registration, product listings, order processing and more. <br />
