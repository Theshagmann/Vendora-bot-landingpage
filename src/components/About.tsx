    ...
    <div className="bg-gradient-to-l min-h-screen" id="about">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 items-center">
              <div className="sm:px-0 px-4">
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                >
                  Our platform enables you to easily create an online store
                  within your Telegram App, offering seamless shopping
                  experience for your customers. Manage your products, track
      ...
      >
        <div className="container mx-auto px-6">
          <h2 className="text-2xl text-center border-2 mx-auto rounded-lg shadow-lg max-w-fit mb-2">
            •Everything You Need•
          </h2>
          <p className="text-gray-600 max-w-lg mx-auto text-center font-bold text-lg mb-10">
            Basic features we offer to make your online selling simple and
            efficient
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
              ...
              {[
                {
                  ...
                  description:
                    "Offer your customers Secure payment for a seamless checkout experience.",
                  backContent:
                    "To enable the safety and assurance of your customers, we use one of the most secure payment methods available.",
                },
                {
                  icon: <FaChartLine className="text-blue-500" size={32} />,
                  title: "Real-Time Analytics",
                  description:
                    "Get real-time insights into your sales and customer behavior.",
                  backContent:
                    "Track sales trends, customer preferences, and inventory levels. Make data-driven decisions with detailed reports and visualizations.",
                },
              ].map((value, index) => (
                <motion.div
                  key={index}
            ...
            >
              ...
              <div className="relative w-full h-[calc(100%-4rem)] rounded-lg overflow-hidden">
                <YoutubeEmbed
                  embedId="yfyzVDJ-MTc"
                  title="Make money on Telegram for Free!!!"
                />
              </div>
            </motion.div>
            <div className="grid md:grid-rows-2 bg-shadow-2xl rounded-3xl gap-8 h-120 ">
              {[
                {
                  icon: (
                    <FaClipboardList className="text-yellow-500" size={32} />
                  ),
                  title: "Flexible Subscriptions",
                  description:
                    "Choose from a variety of subscription plans to suit your business needs.",
                  backContent:
                    "Monthly plansavailable. Scale your business with premium features and priority support. Cancel or upgrade anytime.",
                },
                {
                  ...
                  description: (
                    <div>
                      <p className="text-gray-600 mb-4">
                        Join a community of vendors and customers for support
                        and growth.
                      </p>
                    </div>
                  ),
                  backContent: (
                    <div className="flex flex-col h-full justify-between">
                      <p className="text-gray-700 font-medium mb-4">
                        Connect with successful vendors, share experiences,
                        learn best practices and Promote your business to
                        potential customers. Access exclusive webinars and
                        training materials.
                      </p>
                      <a
                        href="https://t.me/vendorac"
                        className="text-purple-500 font-medium hover:text-purple-600 flex items-center gap-2 mt-auto"
                      >
                        Join Community
      ...
      >
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2
              className="text-2xl border-2 mx-auto rounded-lg shadow-lg max-w-fit mb-4"
              id="how to"
            >
              •How To•
            </h2>
      ...
      >
        <div className=" mx-auto px-6 flex flex-col justify-center items-center">
          <h2 className="text-3xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-b from-black via-black to-[var(--primary)] leading-tight italic mb-2">
            Pricing
          </h2>
          <p className="text-gray-600 max-w-lg mx-auto text-center font-bold text-lg mb-10 ">
            Forever Free. Upgrade for NO transaction fees, analytics and other
            exclusive features.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 w-full max-w-4xl">
            ...
            >
              ...
              <div className="flex mx-auto">
                ...
                <p className=" text-3xl sm:text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-black via-black/60 to-purple-600/40 italic">
                  0
                </p>
              ...
              <div className="text-left space-y-2 flex-grow">
                ...
                <p className="text-sm sm:text-base font-medium text-red-600">
                  • 4% commission on any transaction
                </p>
                <p className="text-base sm:text-lg font-medium">
                  • Unlimited sales
                </p>
            ...
            >
              ...
              <div className="flex flex-col items-center mx-auto">
                <div className="flex items-center">
                  <p className=" text-2xl font-semibold py-1 ">₦</p>
                  <p className=" text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-black via-black/60 to-[var(--primary)]/40 leading-tight italic ">
                    5000
                  </p>
                  <p className="text-xl font-semibold py-1">/mo</p>
                </div>
                <div className="flex items-center mt-1">
                  <p className="text-lg font-semibold text-red-500 line-through leading-tight italic">
                    ₦15,000/mo
                  </p>
                </div>
              </div>
